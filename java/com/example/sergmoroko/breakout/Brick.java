...
public class Brick extends GameObject {
    ...
    private static Bitmap yellowBrick = Bitmap.createScaledBitmap(BitmapFactory.decodeResource
            (GameView.getInstance().getResources(), R.drawable.breakout_brick_yellow), GameConstants.BRICK_WIDTH, GameConstants.BRICK_HEIGHT, false);
    private static Bitmap redBrick = Bitmap.createScaledBitmap(BitmapFactory.decodeResource
            (GameView.getInstance().getResources(), R.drawable.breakout_brick_red), GameConstants.BRICK_WIDTH, GameConstants.BRICK_HEIGHT, false);
    private static Bitmap greenBrick = Bitmap.createScaledBitmap(BitmapFactory.decodeResource
            (GameView.getInstance().getResources(), R.drawable.breakout_brick_green), GameConstants.BRICK_WIDTH, GameConstants.BRICK_HEIGHT, false);
    private static Bitmap stoneBrick = Bitmap.createScaledBitmap(BitmapFactory.decodeResource
            (GameView.getInstance().getResources(), R.drawable.breakout_brick_stone), GameConstants.BRICK_WIDTH, GameConstants.BRICK_HEIGHT, false);
